          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="btn-wrapper text-center">
                <div class="logo ">
                  <a href="<?php echo base_url(); ?>"> <img src="<?php echo base_url(); ?>/assets/img/logo-azul.svg" alt="CEPRE-UNI"></a>
                </div>
              </div>
            </div>
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="post" action="<?php echo base_url() . '/docente/valida'; ?>">
